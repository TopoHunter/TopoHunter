...
```
bin/kafka-topics.sh --create --partitions 1 --replication-factor 1 --bootstrap-server [2001:da8:ff:212::23:1]:9092 --topic topo-command-topic
bin/kafka-topics.sh --create --partitions 1 --replication-factor 1 --bootstrap-server [2001:da8:ff:212::23:1]:9092 --topic topo-result-topic
...
```
bin/kafka-topics.sh --bootstrap-server [2001:da8:ff:212::23:1]:9092 --delete --topic topo-command-topic
bin/kafka-topics.sh --bootstrap-server [2001:da8:ff:212::23:1]:9092 --delete --topic topo-command-topic
```
...
bin/kafka-console-consumer.sh --topic topo-command-topic  --from-beginning --bootstrap-server [2001:da8:ff:212::23:1]:9092
```

### Send Messages
```
bin/kafka-console-producer.sh --topic <topic name> --bootstrap-server [2001:1234::1]:9092
bin/kafka-console-producer.sh --topic topo-command-topic --bootstrap-server [2001:da8:ff:212::23:1]:9092
```
