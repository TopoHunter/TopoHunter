...
public:
   ...
   PyObject* remove_subtree(const char *cidr);
   PyObject* remove_subtree(unsigned long subnet, unsigned short mask);
   ...
   PyObject* lookup_exact(const char *cidr);
   PyObject* lookup_exact(unsigned long subnet, unsigned short mask);

   PyObject* parent(const char *cidr, int size) const;
   PyObject* parent(unsigned long addr, unsigned short mask) const;

   PyObject* children(const char *cidr, int size, bool ipv4_native = false, bool with_len = true) const;
   PyObject* children(unsigned long addr, unsigned short mask, bool ipv4_native = false, bool with_len = true) const;

   PyObject* ancestors(const char *cidr, int size, bool ipv4_native = false, bool with_len = true) const;
   PyObject* ancestors(unsigned long addr, unsigned short mask, bool ipv4_native = false, bool with_len = true) const;

   PyObject* descendant_prefixes(const char *cidr, int size, int number_limit = -1, bool ipv4_native = false, bool with_len = true) const;
   PyObject* descendant_prefixes(unsigned long addr, unsigned short mask, int number_limit = -1, bool ipv4_native = false, bool with_len = true) const;

   PyObject* num_active_node() const;
...
private:
   ...
   PyObject* remove_subtree(int family, inx_addr subnet, unsigned short mask);
   PyObject* lookup(int family, inx_addr subnet) const;
   PyObject* lookup_exact(int family, inx_addr subnet, unsigned short mask);
   PyObject* parent(int family, inx_addr subnet, unsigned short mask) const;
   PyObject* children(int family, inx_addr subnet, unsigned short mask, bool ipv4_native = false, bool with_len = true) const;
   PyObject* ancestors(int family, inx_addr subnet, unsigned short mask, bool ipv4_native = false, bool with_len = true) const;
   PyObject* descendant_prefixes(int family, inx_addr subnet, unsigned short mask, int number_limit = -1, bool ipv4_native = false, bool with_len = true) const;
